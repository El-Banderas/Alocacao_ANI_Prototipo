...
def get_Projects_For_Costs(bd):
    ...
    for project in projects_raw:
        ...
        area = bd.do_command(f"select Area from T_AREA_TEMATICA where Id_Area == {id_area} ")
        tipo = bd.do_command(f"select Tipologia from T_TIPOLOGIA where Id_Tipologia == {id_topo}")
